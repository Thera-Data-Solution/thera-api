...
func (ac *AuthController) UserRegister(c *gin.Context) {
	...
	existing, _ := ac.UserRepo.FindByEmailAndTenant(r.Email, r.TenantId)
	if existing != nil {
	...
	err := ac.UserRepo.CreateUser(user)
	if err != nil {
...
func (ac *AuthController) UserLogin(c *gin.Context) {
	...
	tu, err := ac.UserRepo.FindByEmailAndTenant(r.Email, r.TenantId)
	if err != nil {
...
func (ac *AuthController) UserMe(c *gin.Context) {
