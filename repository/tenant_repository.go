...
func (r *TenantUserRepository) FindByEmailAndTenant(email string, tenantId *string) (*models.TenantUser, error) {
...
func (r *TenantUserRepository) FindTenantById(id string) (*models.TenantUser, error) {
